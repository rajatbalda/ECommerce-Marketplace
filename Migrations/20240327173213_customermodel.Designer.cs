...
namespace AmazonFresh.Migrations
{
    ...
    [Migration("20240327173213_customermodel")]
            ...
            modelBuilder.Entity("AmazonFresh.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 2.99m,
                            SoldCount = 10,
                            StockTimestamp = new DateTime(2024, 3, 22, 23, 2, 12, 37, DateTimeKind.Local).AddTicks(540),
                            TotalQty = 15,
                            Unit = "gram",
                            VendorID = 1,
                            WarehouseID = 1,
                        ...
                        new
                        {
                            ...
                            Price = 10.79m,
                            SoldCount = 26,
                            StockTimestamp = new DateTime(2024, 4, 2, 23, 2, 12, 37, DateTimeKind.Local).AddTicks(550),
                            TotalQty = 15,
                            Unit = "gram",
                            VendorID = 1,
                            WarehouseID = 1,
                        ...
                        new
                        {
                            ...
                            Price = 0.79m,
                            SoldCount = 31,
                            StockTimestamp = new DateTime(2024, 3, 27, 23, 2, 12, 37, DateTimeKind.Local).AddTicks(555),
                            TotalQty = 5,
                            Unit = "gram",
                            VendorID = 2,
                            WarehouseID = 2,
                        ...
                        new
                        {
                            ...
                            Price = 100.79m,
                            SoldCount = 5,
                            StockTimestamp = new DateTime(2024, 3, 27, 23, 2, 12, 37, DateTimeKind.Local).AddTicks(559),
                            TotalQty = 3,
                            Unit = "box",
                            VendorID = 2,
                            WarehouseID = 2,
