...
namespace AmazonFresh.Migrations
{
    ...
    [Migration("20240329140838_productdata")]
            ...
            modelBuilder.Entity("AmazonFresh.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 2.99m,
                            SoldCount = 10,
                            StockTimestamp = new DateTime(2024, 3, 24, 19, 38, 36, 125, DateTimeKind.Local).AddTicks(8054),
                            TotalQty = 15,
                            Unit = "gram",
                            VendorID = 1,
                            WarehouseID = 1,
                        ...
                        new
                        {
                            ...
                            Price = 10.79m,
                            SoldCount = 26,
                            StockTimestamp = new DateTime(2024, 4, 4, 19, 38, 36, 125, DateTimeKind.Local).AddTicks(8071),
                            TotalQty = 15,
                            Unit = "gram",
                            VendorID = 1,
                            WarehouseID = 1,
                        ...
                        new
                        {
                            ...
                            Price = 0.79m,
                            SoldCount = 31,
                            StockTimestamp = new DateTime(2024, 3, 29, 19, 38, 36, 125, DateTimeKind.Local).AddTicks(8077),
                            TotalQty = 5,
                            Unit = "gram",
                            VendorID = 2,
                            WarehouseID = 2,
                        ...
                        new
                        {
                            ...
                            Price = 10.79m,
                            SoldCount = 1,
                            StockTimestamp = new DateTime(2024, 3, 29, 19, 38, 36, 125, DateTimeKind.Local).AddTicks(8083),
                            TotalQty = 7,
                            Unit = "gram",
                            VendorID = 2,
                            WarehouseID = 1,
                        ...
                        new
                        {
                            ...
                            Price = 100.79m,
                            SoldCount = 5,
                            StockTimestamp = new DateTime(2024, 3, 29, 19, 38, 36, 125, DateTimeKind.Local).AddTicks(8090),
                            TotalQty = 3,
                            Unit = "box",
                            VendorID = 2,
                            WarehouseID = 2,
